...
class DAO
{
    ...
    // --------------------------------------------------------------------------------------
    // début de la zone attribuée au développeur 1 (Baptiste) : lignes 350 à 549
    // --------------------------------------------------------------------------------------
    ...
    public function getLesUtilisateursAutorisant($idUtilisateur){
        $txt_req = "Select id, pseudo, mdpSha1, adrMail, numTel, niveau, dateCreation, nbTraces, dateDerniereTrace";
        $txt_req .= " from tracegps_vue_utilisateurs JOIN tracegps_autorisations on tracegps_vue_utilisateurs.id = tracegps_autorisations.idAutorisant";
    ...
    public function getLesUtilisateursAutorises($idUtilisateur){
        $txt_req = "Select id, pseudo, mdpSha1, adrMail, numTel, niveau, dateCreation, nbTraces, dateDerniereTrace";
        $txt_req .= " from tracegps_vue_utilisateurs JOIN tracegps_autorisations on tracegps_vue_utilisateurs.id = tracegps_autorisations.idAutorise";
    ...
    public function getUneTrace($idTrace)
    {
        ...
        $txt_req = "SELECT id, dateDebut, dateFin, terminee, idUtilisateur FROM tracegps_vue_traces ";
    ...
    {
        $txt_req = "Select id, dateDebut, dateFin, terminee";
        $txt_req .= " from tracegps_vue_traces inner join tracegps_autorisations on tracegps_vue_traces.idUtilisateur = tracegps_autorisations.idAutorisant";
        $txt_req .= " where idAutorise = :idUtilisateur";
    ...
    public function terminerUneTrace($unIdTrace)
    {
        // préparation de la requête
        ...
        $req1 = $this->cnx->prepare($txt_req1);
        $req1->bindValue("idTrace", utf8_decode($unIdTrace), PDO::PARAM_STR);
        $lesPointsDeTrace = $this->getLesPointsDeTrace($unIdTrace);
