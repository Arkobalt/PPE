...
$code_reponse = 406;
    ...
    {	// récupération de la liste des utilisateurs à l'aide de la méthode getLesUtilisateursAutorises de la classe DAO
        $unUtilisateurAutorisant = $dao->getUnUtilisateur($pseudo);
        $unIdUtilisateur = $unUtilisateurAutorisant->getId();
        $lesUtilisateurs = $dao->getLesUtilisateursAutorises($unIdUtilisateur);
